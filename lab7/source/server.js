...
app.get('/', (req, res,next) => {
  ...
  res.write("<button id='videoPlay' onclick='playVideo()'>Play Video</button>")
  res.write("<button id='videoPause' onclick='pauseVideo()'>Pause Video</button>")
  ...
  if(req.query.audioFile){
	res.write("<audio controls id='audioPlayer' src='" + req.query.audioFile +"' controls></audio><br>");
  ...
  res.write("<button type='button' onclick='addElement(this)' id='audioAdd' src='" + req.query.audioFile +"'>Add Audio</button><br>");
  res.write("<button id='audioPlay' onclick='playAudio()'>Play Audio</button>")
  res.write("<button id='audioPause' onclick='pauseAudio()'>Pause Audio</button>")
